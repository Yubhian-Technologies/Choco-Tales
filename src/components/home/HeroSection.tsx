        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left animate-fade-in-up">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0">
                Premium Indian handcrafted chocolates made with real cocoa, 
                real milk, and real dry fruits. Experience indulgence in its purest form.
              </p>
            </div>
          ...
          <div className="relative animate-fade-in">
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="relative bg-card rounded-3xl p-8 shadow-soft-lg">
                <img
                  src="/placeholder.svg"
                  alt="Premium Handcrafted Chocolates"
